 ...
 */
class FeatureInfoButton extends React.Component {
    static propTypes = {
        id: PropTypes.string,
    ...
    render() {
        const dialog =
            (<Dialog id={"modal_" + this.props.id} style={assign({}, this.props.style, {display: this.state.isVisible ? "block" : "none"})}>
